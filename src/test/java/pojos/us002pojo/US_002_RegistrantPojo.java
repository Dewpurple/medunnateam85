...
public class US_002_RegistrantPojo {
    ...
    public class US002RegistrantPojo {
        ...
        public US002RegistrantPojo(String firstName, String lastName, String ssn, String login, String password, String email) {
